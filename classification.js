(() => {
  ...
  const CONCEPTS = Object.freeze([
    ...
    { id: 'style-indian', dimension: 'cuisineStyle', label: '印度料理', aliases: ['印度料理', 'インド料理', 'Indian restaurant'] },
    ...
    { id: 'venue-dining-bar', dimension: 'venueType', label: '餐酒馆', aliases: ['餐酒馆', 'ダイニングバー・バル'] },
  ...
  window.EAT_CLASSIFICATION = Object.freeze({
    version: 'classification-v1-20260917',
