(() => {
  ...
  // These are display-only approximate recommendations. Stronger source-backed
  // dishes always win. There is intentionally NO universal restaurant fallback.
  // Rules are ordered from narrow/high-signal to broader cuisine-class inference.
  const RULES = [
    // --- Chain / recognizable restaurant families ---
    ...
    { id:'brand-yudetaro', tier:'brand', re:/ゆで太郎/iu, dishes:['荞麦面','炸蔬菜天妇罗'] },
    ...
    { id:'brand-konshinya', tier:'brand', re:/魂心家/iu, dishes:['横滨家系拉面','叉烧'] },
    ...
    { id:'brand-sapana', tier:'brand', re:/sapana|サパナ/iu, dishes:['印度咖喱','烤饼'] },
    { id:'brand-tarii', tier:'brand', re:/ターリー屋/iu, dishes:['印度咖喱','烤饼'] },
    { id:'brand-mumbai', tier:'brand', re:/ムンバイ|mumbai/iu, dishes:['印度咖喱','烤饼'] },
    { id:'brand-topca', tier:'brand', re:/トプカ/iu, dishes:['印度咖喱','香料鸡肉'] },
    { id:'brand-genchan', tier:'brand', re:/築地食堂\s*源ちゃん|築地食堂源ちゃん/iu, dishes:['生鱼片拼盘','海鲜盖饭'] },
    { id:'brand-ginji', tier:'brand', re:/目利きの銀次/iu, dishes:['生鱼片拼盘','海鲜盖饭'] },
    { id:'brand-daisyo-suisan', tier:'brand', re:/大庄水産/iu, dishes:['生鱼片拼盘','烤鱼'] },
    { id:'brand-myojinmaru', tier:'brand', re:/明神丸/iu, dishes:['稻草炙烤鲣鱼','鲣鱼刺身'] },
    { id:'brand-mazume', tier:'brand', re:/マヅメ|釣宿酒場/iu, dishes:['生鱼片拼盘','烤鱼'] },
    { id:'brand-konakara', tier:'brand', re:/こなから/iu, dishes:['关东煮','炖萝卜'] },
    { id:'brand-keisuke-chicken', tier:'brand', re:/鶏王けいすけ|鶏王/iu, dishes:['浓厚鸡汤拉面','叉烧'] },

    // --- Explicit dish / ingredient / cooking keywords in restaurant names ---
    ...
    { id:'dish-niboshi', tier:'dish-keyword', re:/煮干し|煮干/iu, dishes:['煮干拉面','叉烧'] },
    { id:'dish-shio-shoga', tier:'dish-keyword', re:/塩生姜/iu, dishes:['盐味生姜拉面','叉烧'] },
    ...
    { id:'dish-men-ya', tier:'dish-keyword', re:/麺屋|麺匠|麺巧|麺家/iu, dishes:['拉面','叉烧'] },
    ...
    { id:'dish-curry', tier:'dish-keyword', re:/カレー|カリー|\bcurry\b|咖喱/iu, dishes:['咖喱饭','炸猪排咖喱'] },
    ...
    { id:'dish-oyster', tier:'dish-keyword', re:/牡蠣|カキ小屋|oyster/iu, dishes:['烤牡蛎','炸牡蛎'] },
    ...
    { id:'dish-katsuo', tier:'dish-keyword', re:/鰹|かつお|カツオ|鲣鱼/iu, dishes:['炙烤鲣鱼','鲣鱼刺身'] },
    { id:'dish-seafood-name', tier:'dish-keyword', re:/海の幸|水産|漁場|魚市場|さかな|魚料理|海鮮/iu, dishes:['生鱼片拼盘','烤鱼'] },
    { id:'dish-yakitori', tier:'dish-keyword', re:/焼き鳥|焼鳥|やきとり|烧鸟/iu, dishes:['烤鸡串','鸡腿肉串'] },
    { id:'dish-chicken-name', tier:'dish-keyword', re:/鶏ヤロー|鳥福|鳥劇場|鳥一番|鳥どり|若どり|若鶏|地鶏|鶏料理|食鳥肉/iu, dishes:['烤鸡串','日式炸鸡'] },
    ...
    { id:'dish-kushi-name', tier:'dish-keyword', re:/串焼き|串焼|串料理|串だおれ/iu, dishes:['烤串拼盘','鸡肉串'] },
    { id:'dish-yakiniku', tier:'dish-keyword', re:/焼肉|ホルモン|烧肉|烤肉/iu, dishes:['烤肉拼盘','牛舌'] },
    { id:'dish-shokuniku', tier:'dish-keyword', re:/食肉センター|食肉中心/iu, dishes:['烤肉拼盘','牛舌'] },
    { id:'dish-butcher', tier:'dish-keyword', re:/butcher|ブッチャー|aging\s*beef/iu, dishes:['牛排','烤牛肉'] },
    ...
    { id:'dish-okonomiyaki', tier:'dish-keyword', re:/お好み焼|もんじゃ|御好烧|大阪烧|文字烧/iu, dishes:['大阪烧','文字烧'] },
    ...
    { id:'dish-robata', tier:'dish-keyword', re:/炉端|ろばた/iu, dishes:['炉端烤鱼','炭火烤鸡'] },
    ...
    { id:'dish-banhxeo', tier:'dish-keyword', re:/バインセオ|bánh\s*xèo|banh\s*xeo/iu, dishes:['越南煎饼','越南春卷'] },
    { id:'dish-pho', tier:'dish-keyword', re:/フォー|\bpho\b/iu, dishes:['越南河粉','越南春卷'] },
    ...
    { id:'dish-obanzai', tier:'dish-keyword', re:/おばんざい/iu, dishes:['京都家常小菜','炖蔬菜'] },
    { id:'dish-yamaimo', tier:'dish-keyword', re:/自然薯|自然生/iu, dishes:['山药泥麦饭','山药泥'] },

    // --- Specific cuisine classes ---
    ...
    { id:'cuisine-okinawa', tier:'cuisine', re:/沖縄|冲绳/iu, dishes:['冲绳荞麦面','苦瓜炒蛋'] },
    { id:'cuisine-hawaiian', tier:'cuisine', re:/ハワイ|hawaii|夏威夷/iu, dishes:['夏威夷盖饭','蒜香虾'] },
    { id:'cuisine-american', tier:'cuisine', re:/アメリカン|美式/iu, dishes:['芝士汉堡','炸鸡'] },
    { id:'cuisine-yakiniku-cn', tier:'cuisine', re:/烧肉/iu, dishes:['烤肉拼盘','牛舌'] },
    { id:'cuisine-yakitori-cn', tier:'cuisine', re:/烧鸟/iu, dishes:['烤鸡串','鸡腿肉串'] },
    { id:'cuisine-grill-cn', tier:'cuisine', re:/烧烤/iu, dishes:['烤肉拼盘','烤蔬菜'] },
    { id:'cuisine-okonomiyaki-cn', tier:'cuisine', re:/御好烧/iu, dishes:['大阪烧','日式炒面'] },

    // --- Broad but still food-bearing classes. These are the minimum accepted
    // threshold for v2 bulk coverage: they are more informative than restaurant/bar
    // and always produce concrete dishes. Generic 餐厅/酒吧 remains intentionally blank.
    { id:'broad-japanese', tier:'broad-cuisine', re:/(^|\s)(和食|日式|日本料理)($|\s)/iu, dishes:['烤鲭鱼','日式炸鸡'] },
    { id:'broad-izakaya', tier:'broad-cuisine', re:/居酒屋|大衆酒場|大衆izakaya/iu, dishes:['烤鸡串','日式炸鸡'] },
    { id:'broad-setmeal', tier:'broad-cuisine', re:/定食|食堂/iu, dishes:['姜烧猪肉套餐','烤鲭鱼套餐'] }
  ];
