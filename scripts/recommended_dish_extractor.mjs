...
export const DISH_RULES = [
  ...
  // 2026-09-10 reviewed retained-source normalizations. These are direct
  // source-native dish-name normalizations; no cuisine/name/brand inference is used.
  [/のり巻/i, '海苔卷寿司'],
  [/パーコー麺/i, '排骨面'],
  [/クスクス/i, '库斯库斯'],
  [/タジン鍋/i, '塔吉锅'],
