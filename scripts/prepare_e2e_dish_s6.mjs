...
const decisions = {
  ...
  'ChIJ5-vLPkKNGGARQA0BDgfPFi4': {
    status:'candidate', identity:{state:'verified',sourceAliases:['夢いち輪'],evidence:[
    ...
    ]}, dishProposals:[dish({classification:'C',nameOriginal:'海老真丈のサクサク揚げ',provider:'Tabelog',
      sourceUrl:'https://tabelog.com/tokyo/A1310/A131002/13288959/dtlmenu/',sourceTitle:'料理メニュー : 夢いち輪',
      evidenceText:'揚げもの オリジナルの海老真丈です。 おすすめ 海老真丈のサクサク揚げ',recommendationSemantics:'おすすめ',confidence:'low',
      freshness:'conflicting current-status evidence: Tabelog says temporarily closed for relocation from June 2026 while other reservation listings still show hours',notes:'Avoided explicitly seasonal items; menu notes that offerings can change with procurement, so confidence is medium.'})],
    ...
    notes:'Candidate only: dish-level recommendation semantics are explicit, but conflicting 2026 relocation/temporary-closure status prevents treating the old branch menu as current canonical truth.'
  },
...
const translations = {
  ...
  'NYCベーグルサンド':{nameZh:'NYC贝果三明治',rationale:'NYC bagel sandwich direct translation.'},
