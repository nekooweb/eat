...
window.RESTAURANTS.push(
  {
    ...
    name:'四川料理 川国志 神保町店', googlePlaceId:'ChIJUaWV4xCMGGARTPeZsPzPaTg',
    source:'Tabelog', sourceOnly:true, cuisine:'中华', tags:['中华','四川菜'],
    sourceRefs:[{provider:'Tabelog',url:'https://tabelog.com/tokyo/A1310/A131003/13177561/',checkedAt:'2026-09-05',fields:['name','cuisine']}]
  },
  {
    id:'src-tabelog-stmarc-jimbocho-suzuran', profile:'TOKYO', area:'地区1️⃣',
    name:'サンマルクカフェ 神保町すずらん通り店', googlePlaceId:'ChIJvzR62xCMGGARLMrcUxNzQoM',
  ...
  },
  {
    ...
    name:'喫茶トお酒 襤褸', googlePlaceId:'ChIJh5-vvI6NGGARzpQgBn_N9AU',
  ...
  },
  {
    ...
    name:'つけそば 神田 勝本', googlePlaceId:'ChIJJ9j8twyMGGAR-CJja1RAm9E',
  ...
  },
  {
    ...
    name:'から好し 神田神保町店', googlePlaceId:'ChIJLcwVdxCMGGAR3PSntkNI2qw',
  ...
  },
  {
    ...
    name:'俺の創作らぁめん 極や 神田 神保町店', googlePlaceId:'ChIJRWXE-RGMGGARwJ1R05IOvuc',
    ...
    sourceRefs:[{provider:'Tabelog',url:'https://tabelog.com/tokyo/A1310/A131003/13132295/',checkedAt:'2026-09-05',fields:['name','cuisine','hours','closure']}]
  },
  {
    id:'src-tabelog-hinoya-curry-jimbocho', profile:'TOKYO', area:'地区1️⃣',
    name:'日乃屋カレー 神保町店', googlePlaceId:'ChIJaZqCyROMGGARUVoE9FyQgQs',
    source:'Tabelog', sourceOnly:true, cuisine:'咖喱', tags:['咖喱'],
    lunch:[1000,1999], dinner:[1000,1999],
    sourceRefs:[{provider:'Tabelog',url:'https://tabelog.com/tokyo/A1310/A131003/13197956/',checkedAt:'2026-09-05',fields:['name','cuisine','budget']}]
  },
  {
    id:'src-tabelog-ono-grill-tokyo', profile:'TOKYO', area:'地区1️⃣',
    name:'Ono Grill Tokyo', googlePlaceId:'ChIJUxhyF9yNGGARVQg-3XGk5-k',
